...
data_prep = data_cl[['Nama Pekerjaan', 'Ukuran Perusahaan',
...
q_hi  = dataset["MeanGaji"].quantile(0.98)
...
category_col =['Nama Pekerjaan', 'Ukuran Perusahaan',
...
param_grid = [
    ...
    {'n_estimators': [3, 10, 30, 50, 80, 100, 150, 200],
     'max_features': [2, 4, 6, 8, 10, 15, 20, 30, 40]},
    # then try 6 (2×3) combinations with bootstrap set as False
    {'bootstrap': [False], 'n_estimators': [3, 10, 30, 50, 80, 100, 150, 200],
     'max_features': [2, 4, 6, 8, 10, 15, 20, 30, 40]},
  ]
